...
TARGET_DIR="target"
PROJECT_DIR="orange-sdk-android"
...
$UNIFFI_BINDGEN_BIN generate --config uniffi-android.toml --library $TARGET_DIR/aarch64-linux-android/release-smaller/liborange_sdk.so --language kotlin -o "$BINDINGS_DIR"/"$PROJECT_DIR"/lib/src/main/kotlin || exit 1
