...
PROJECT_DIR="orange-sdk-jvm"
PACKAGE_DIR="org/lightningdevkit/orangesdk"
...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
	...
	DYNAMIC_LIB_PATH="target/x86_64-unknown-linux-gnu/release/liborange_sdk.so"
	...
	DYNAMIC_LIB_PATH="target/x86_64-apple-darwin/release/liborange_sdk.dylib"
	...
	DYNAMIC_LIB_PATH="target/aarch64-apple-darwin/release/liborange_sdk.dylib"
